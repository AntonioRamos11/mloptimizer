...
def parse_debug_log(log_file="debug.log"):
...
def visualize_events(events):
    ...
    plt.tight_layout()
    plt.savefig('optimization_flow.png')
    plt.close()
    
    print(f"Visualization saved as optimization_flow.png")

if __name__ == "__main__":
    events = parse_debug_log()
